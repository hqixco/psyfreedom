...
export const specialistDetails: SpecialistDetails = {
  ...
  about:
    'Если вы спросите у психологов: «За что вам платят?», многие начнут говорить про образование, методы или опыт. Но на самом деле ко мне приходят за возможностью наконец-то услышать себя, снизить тревогу и найти опору там, где раньше был только хаос. Я работаю мягко и структурно, без давления, помогая клиенту идти в темпе, который ему подходит.',
  methods: [
  ...
  reviews: [
    ...
    },
    {
      ...
      date: '7 декабря 2023',
      text: 'Стал лучше понимать, откуда берётся тревога, и какие инструменты помогают не проваливаться в неё полностью.',
      rating: 5,
      avatar: reviewAvatar,
    },
  ],
