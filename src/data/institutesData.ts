  ...
  reviews: [
    {
      ...
      text:
        'Вы разберётесь в себе, своих желаниях и ценностях вместе с профессиональными психологами. Научитесь рефлексировать, отстаивать личные границы, замечать эмоции и совершать осознанный выбор.',
    },
    {
      id: '2',
      author: 'Ирина Макарова',
...
export const institutesMock: InstituteDetails[] = [instituteDetailsMock];
